...
import { AppSettings } from './SettingsModal.tsx';
...
export const AgentConfigurator: React.FC<AgentConfiguratorProps> = ({ agents, onUpdateAgent, settings }) => {
                    ...
                    <div key={agent.id} className="p-3 bg-neutral-50 rounded-xl border border-neutral-200 space-y-2">
                        ...
                        <div className="flex gap-2">
                            ...
                            <div className="w-2/3 relative">
                                {agent.provider !== 'none' ? (
                                    isLoading ? (
                                        <div className="w-full px-3 py-2 rounded-lg border border-neutral-300 bg-neutral-100 text-sm text-neutral-500 flex items-center">
                                        ...
                                        <input
                                            ...
                                            placeholder="Model ID (API Key needed to load list)"
                                        />
                                    )
                                ) : (
                                    <input
